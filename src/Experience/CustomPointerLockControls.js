...
class CustomPointerLockControls extends EventDispatcher {
    ...
    constructor( camera, domElement ) {
        ...
        if ( domElement === undefined ) {
            ...
            console.warn( 'CustomPointerLockControls: The second parameter "domElement" is now mandatory.' )
        ...
        function onPointerlockError() {
            ...
            console.error( 'CustomPointerLockControls: Unable to use Pointer Lock API' )
