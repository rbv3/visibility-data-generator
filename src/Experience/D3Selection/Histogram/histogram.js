...
export default class Histogram{
    constructor(){
        ...
        // this.particleHelper.on("updatedQueryResult", () => {
            
        //     this.particles = this.particleHelper.lastResult;
        //     console.log(this.particleHelper.lastResult.data)

        //     global_locations   = this.particleHelper.lastResult;
        //     selected_locations = this.particleHelper.lastResult;
            
        //     console.log("Creating histogram...")
        //     // createHistogram(global_locations.data);
